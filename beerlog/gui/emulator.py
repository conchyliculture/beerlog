...
class Emulator(gui_base.BaseGUI):
  ...
  def _SetupUI(self):
    ...
    joystick_grid.attach_next_to(button_right, button_click, Gtk.PositionType.RIGHT, 1, 1)
    joystick_grid.attach_next_to(button_left, button_click, Gtk.PositionType.LEFT, 1, 1)
    joystick_grid.attach_next_to(button_up, button_click, Gtk.PositionType.TOP, 1, 1)
    joystick_grid.attach_next_to(button_down, button_click, Gtk.PositionType.BOTTOM, 1, 1)
  ...
  def _OnUIButtonClicked(self, button):
    ...
    if event_type:
      ...
      logging.warning("Not implemented button: {0:s} (check self._BUTTON_DICT".format(label))
